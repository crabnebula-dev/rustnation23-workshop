...
pub fn TitleBar() -> Html {
    html! {
        <div class="titlebar" data-tauri-drag-region="true">
            <div class="titlebar-cell1" data-tauri-drag-region="true"></div>
            <div class="titlebar-cell2" data-tauri-drag-region="true"></div>
            <div class="titlebar-cell3" data-tauri-drag-region="true">
